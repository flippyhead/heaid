...
void flanjah_protect(t_flanjah *x, double state);
void flanjah_mute(t_flanjah *x, short state);
...
void flanjah_float(t_flanjah *x, t_float f);
...
void main(void)
{
  ...
  addmess((method)flanjah_mute, "mute", A_LONG, 0);
...
void flanjah_float(t_flanjah *x, t_float f) // Look at floats at inlets
{
