{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 389.0, 356.0, 967.0, 491.0 ],
		"bglocked" : 0,
		"defrect" : [ 389.0, 356.0, 967.0, 491.0 ],
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "An abstraction that embeds a jit.qt.movie, buffer~ and groove~ all in one place. This allows us to use audio-rate playback control of a movie content, and easily process it's audio output.",
					"linecount" : 2,
					"patching_rect" : [ 15.0, 75.0, 526.0, 34.0 ],
					"id" : "obj-17",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "Driving a jit.qt.movie from a groove~",
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "playback rate",
					"patching_rect" : [ 315.0, 120.0, 81.0, 20.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "sig~ 1.",
					"patching_rect" : [ 315.0, 180.0, 46.0, 20.0 ],
					"id" : "obj-16",
					"outlettype" : [ "signal" ],
					"fontname" : "Arial",
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "waaa.qt.groove~ @name gravy @adapt 1",
					"patching_rect" : [ 240.0, 255.0, 233.0, 20.0 ],
					"id" : "obj-61",
