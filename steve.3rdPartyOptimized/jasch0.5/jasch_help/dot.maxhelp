	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 446.0, 305.0, 53.0, 19.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 445.0, 281.0, 52.0, 19.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"id" : "obj-2",
					"numinlets" : 1,
					"patching_rect" : [ 464.0, 423.0, 18.0, 18.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 422.0, 423.0, 32.0, 19.0 ],
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "1 ga ge gi go gu",
					"id" : "obj-5",
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 447.0, 353.0, 91.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 447.0, 330.0, 40.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 422.0, 395.0, 17.0, 19.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-19",
					"numinlets" : 1,
					"patching_rect" : [ 422.0, 260.0, 18.0, 18.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "(dot) - the fastest bang in the west",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-36",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 75.0, 26.0, 188.0, 19.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 20.0,
					"numinlets" : 1,
					"patching_rect" : [ 20.0, 16.0, 25.0, 31.0 ],
					"numoutlets" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontname" : "Verdana"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 456.5, 372.0, 431.5, 372.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 456.5, 350.0, 431.0, 350.0, 431.0, 392.0, 431.5, 392.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 431.5, 380.0, 431.5, 380.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 454.5, 302.0, 431.0, 302.0, 431.0, 380.0, 431.5, 380.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 455.5, 326.0, 431.0, 326.0, 431.0, 380.0, 431.5, 380.0 ]
				}
