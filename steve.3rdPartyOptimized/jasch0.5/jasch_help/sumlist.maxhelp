	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 375.0, 387.0, 47.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 514.0, 305.0, 66.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 466.0, 305.0, 37.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"fontname" : "Verdana"
...
, 			{
				"box" : 				{
					...
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 394.0, 305.0, 37.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Verdana"
...
, 			{
				"box" : 				{
					...
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 430.0, 305.0, 37.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Verdana"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 3,
					"patching_rect" : [ 394.0, 326.0, 91.0, 19.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 375.0, 361.0, 46.0, 19.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-19",
					"numinlets" : 1,
					"patching_rect" : [ 375.0, 305.0, 15.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "calculate the sum of a list",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-36",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 104.0, 26.0, 140.0, 19.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 20.0,
					"numinlets" : 1,
					"patching_rect" : [ 20.0, 16.0, 82.0, 31.0 ],
					"numoutlets" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontname" : "Verdana"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 384.0, 351.0, 384.5, 351.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 403.5, 351.0, 384.5, 351.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-11", 0 ],
					"hidden" : 0,
					"midpoints" : [ 523.5, 351.0, 384.5, 351.0 ]
				}
