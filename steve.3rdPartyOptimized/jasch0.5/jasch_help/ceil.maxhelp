	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 449.0, 369.0, 53.0, 19.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-4",
					"numinlets" : 1,
					"patching_rect" : [ 510.0, 309.0, 15.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 449.0, 338.0, 27.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 449.0, 308.0, 52.0, 19.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "next higher integer from float, (also in the negative range)",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-36",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 75.0, 26.0, 307.0, 19.0 ],
					"numoutlets" : 0,
