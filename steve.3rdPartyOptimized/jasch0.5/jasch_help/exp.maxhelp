	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 471.0, 306.0, 45.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Verdana"
...
, 			{
				"box" : 				{
					...
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 428.0, 367.0, 119.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 428.0, 306.0, 44.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"fontname" : "Verdana"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 428.0, 336.0, 27.0, 19.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-16",
					"numinlets" : 1,
					"patching_rect" : [ 412.0, 306.0, 15.0, 15.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "bang" ]
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "e^n (euler constant raised to nth power)",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-36",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 75.0, 26.0, 217.0, 19.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 20.0,
					"numinlets" : 1,
					"patching_rect" : [ 20.0, 16.0, 47.0, 31.0 ],
					"numoutlets" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontname" : "Verdana"
				}
