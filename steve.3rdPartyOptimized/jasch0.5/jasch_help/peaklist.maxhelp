	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"types" : [  ],
					"patching_rect" : [ 526.243042, 298.364868, 85.0, 19.0 ],
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 526.243042, 318.067566, 53.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "reads list from front to back, if two identical high values are present the one occuring later in the list is output",
					"linecount" : 2,
					"id" : "obj-5",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 337.986115, 427.067566, 294.0, 31.0 ],
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 414.050934, 367.608093, 45.0, 19.0 ],
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 379.141205, 390.594604, 46.0, 19.0 ],
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "100 2 3 4 5.5 4 0.1 3 2 1",
					"id" : "obj-10",
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 350.636566, 290.702698, 138.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 374.96759, 368.418915, 37.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 339.0, 390.310822, 37.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"fontname" : "Verdana"
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "1 2 3 4 5.5 4 3 2 1 5.5 3",
					"id" : "obj-13",
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 364.388885, 309.310822, 137.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 339.0, 344.33783, 49.0, 19.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					"maxclass" : "message",
					"text" : "3 4 2 1 1 1 1 2 45.8 1 8.34 -2 3 4 5.5 4 3 2 1",
					"id" : "obj-22",
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 339.0, 271.0, 245.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "find the highest value in list of ints/floats - argument optional <int> mode, default 0",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-36",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 109.0, 26.0, 438.0, 19.0 ],
					"numoutlets" : 0,
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-14", 0 ],
					"hidden" : 0,
					"midpoints" : [ 535.743042, 338.864868, 348.5, 338.864868 ]
				}
