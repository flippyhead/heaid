	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 0,
					"patching_rect" : [ 572.0, 374.0, 61.0, 19.0 ],
					"numoutlets" : 0,
					"fontname" : "Verdana",
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 498.0, 44.0, 351.0, 346.0 ],
						"bglocked" : 0,
						"defrect" : [ 498.0, 44.0, 351.0, 346.0 ],
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "loadmess brgb 232 232 232",
									"id" : "obj-1",
									"fontsize" : 10.0,
									"numinlets" : 1,
									"patching_rect" : [ 166.0, 41.0, 152.0, 19.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Verdana"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "message",
									"text" : "clear, brgb 232 232 232, linesegment 64 64 $1 $2",
									"linecount" : 2,
									"id" : "obj-2",
									"fontsize" : 10.0,
									"numinlets" : 2,
									"patching_rect" : [ 142.0, 201.0, 138.0, 29.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Verdana"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"patching_rect" : [ 56.0, 261.0, 89.0, 19.0 ],
...
, 							{
								"box" : 								{
									...
									"fontsize" : 10.0,
									"numinlets" : 1,
									"patching_rect" : [ 56.0, 202.0, 83.0, 19.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Verdana"
								}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 10.0,
									"numinlets" : 1,
									"patching_rect" : [ 55.0, 219.0, 47.0, 19.0 ],
									"numoutlets" : 2,
									"outlettype" : [ "int", "int" ],
									"fontname" : "Verdana"
								}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 10.0,
									"numinlets" : 2,
									"patching_rect" : [ 56.0, 239.0, 43.0, 19.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"fontname" : "Verdana"
								}
...
, 							{
								"box" : 								{
									...
									"local" : 0,
									"numinlets" : 1,
									"patching_rect" : [ 56.0, 69.0, 128.0, 128.0 ],
									"numoutlets" : 4,
...
, 							{
								"box" : 								{
									"maxclass" : "comment",
									"text" : "length of the radius from the centre",
									"linecount" : 2,
									"frgb" : [ 0.498039, 0.498039, 0.498039, 1.0 ],
									"id" : "obj-8",
									"fontsize" : 10.0,
									"numinlets" : 1,
									"patching_rect" : [ 59.0, 29.0, 111.0, 31.0 ],
									"numoutlets" : 0,
						...
						"lines" : [ 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-2", 0 ],
									"hidden" : 0,
									"midpoints" : [ 65.5, 199.0, 151.5, 199.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-7", 0 ],
									"hidden" : 0,
									"midpoints" : [ 151.5, 230.0, 284.0, 230.0, 284.0, 64.0, 65.5, 64.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"destination" : [ "obj-7", 0 ],
									"hidden" : 0,
									"midpoints" : [ 175.5, 64.0, 65.5, 64.0 ]
								}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "The longest leg of a right triangle (which is the side opposite the right angle). The word derives from the Greek hypo- (\"under\") and teinein \"(to stretch).\"",
					"linecount" : 2,
					"id" : "obj-4",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 270.0, 411.0, 404.0, 31.0 ],
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 356.0, 378.0, 67.0, 19.0 ],
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 319.0, 306.0, 44.0, 19.0 ],
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 273.0, 306.0, 39.0, 19.0 ],
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 273.0, 376.0, 82.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"fontname" : "Verdana"
...
, 			{
				"box" : 				{
					...
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 319.0, 321.0, 45.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"fontname" : "Verdana"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 273.0, 348.0, 37.0, 19.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"numinlets" : 1,
					"patching_rect" : [ 273.0, 321.0, 45.0, 19.0 ],
					"triscale" : 0.9,
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"fontname" : "Verdana"
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "the hypotenuse calculated from the length of two sides -> sqrt(a^2+b^2)",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-36",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 88.0, 26.0, 386.0, 19.0 ],
					"numoutlets" : 0,
