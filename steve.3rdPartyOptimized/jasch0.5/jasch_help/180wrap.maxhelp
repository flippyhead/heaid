	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 50.0, 97.0, 856.0, 492.0 ],
						"bglocked" : 0,
						"defrect" : [ 50.0, 97.0, 856.0, 492.0 ],
...
, 							{
								"box" : 								{
									...
									"fontsize" : 10.0,
									"numinlets" : 2,
									"patching_rect" : [ 276.0, 108.0, 580.0, 53.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Verdana"
								}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 10.0,
									"numinlets" : 1,
									"patching_rect" : [ 96.0, 168.0, 158.0, 19.0 ],
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"fontname" : "Verdana"
								}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 415.0, 262.294739, 54.0, 19.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "wrap angles from -180º to + 180º",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-36",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 126.0, 26.0, 184.0, 19.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 20.0,
					"numinlets" : 1,
					"patching_rect" : [ 20.0, 16.0, 100.0, 31.0 ],
					"numoutlets" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"id" : "obj-17",
					"numinlets" : 1,
					"patching_rect" : [ 2.0, 0.0, 952.0, 64.0 ],
					"numoutlets" : 0,
