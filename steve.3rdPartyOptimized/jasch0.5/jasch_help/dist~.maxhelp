	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 388.0, 307.0, 52.0, 19.0 ],
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 328.0, 284.0, 52.0, 19.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 383.0, 285.0, 94.0, 19.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"sig" : 0.0,
					"patching_rect" : [ 328.0, 405.0, 92.0, 19.0 ],
					"interval" : 50.0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 328.0, 383.0, 48.0, 19.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "dB drop per distance unit",
					"frgb" : [ 0.454902, 0.454902, 0.454902, 1.0 ],
					"id" : "obj-6",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 443.0, 307.0, 139.0, 19.0 ],
					"numoutlets" : 0,
					"textcolor" : [ 0.454902, 0.454902, 0.454902, 1.0 ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 328.0, 305.0, 46.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 388.0, 328.0, 66.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 423.0, 406.0, 25.0, 19.0 ],
					"numoutlets" : 0,
					"textcolor" : [ 0.454902, 0.454902, 0.454902, 1.0 ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 610.0, 382.0, 36.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 536.0, 381.0, 73.0, 17.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 536.0, 405.0, 37.0, 19.0 ],
					"numoutlets" : 0,
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 340.0, 333.0, 47.0, 19.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 328.0, 361.0, 51.0, 19.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Verdana"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "distance gain: logarithmic - argument (optional): dB drop per distance unit",
					"frgb" : [ 1.0, 1.0, 1.0, 1.0 ],
					"id" : "obj-36",
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 86.0, 26.0, 390.0, 19.0 ],
					"numoutlets" : 0,
...
, 			{
				"box" : 				{
					...
					"fontsize" : 20.0,
					"numinlets" : 1,
					"patching_rect" : [ 20.0, 16.0, 63.0, 31.0 ],
					"numoutlets" : 0,
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ],
					"fontname" : "Verdana"
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 337.5, 358.0, 337.5, 358.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-18", 0 ],
					"hidden" : 0,
					"midpoints" : [ 397.5, 358.0, 337.5, 358.0 ]
				}
