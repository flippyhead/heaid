	...
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 682.0, 81.0, 58.0, 18.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"fontname" : "Arial",
					"id" : "obj-3"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 3,
					"patching_rect" : [ 719.0, 371.0, 61.0, 20.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
					"id" : "obj-18"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 682.0, 105.0, 43.0, 18.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "", "clear" ],
					"fontname" : "Arial",
					"id" : "obj-26"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 0,
					"patching_rect" : [ 681.0, 61.0, 102.0, 18.0 ],
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial",
					"id" : "obj-36"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 139.0, 112.0, 67.0, 18.0 ],
					"numoutlets" : 1,
					"hidden" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 1,
					"patching_rect" : [ 851.0, 335.0, 67.0, 18.0 ],
					"numoutlets" : 1,
					"hidden" : 1,
					"outlettype" : [ "" ],
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 10.0,
					"numinlets" : 2,
					"patching_rect" : [ 851.0, 358.0, 52.0, 18.0 ],
					"numoutlets" : 0,
					"hidden" : 1,
					"fontname" : "Arial",
					"id" : "obj-48"
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 3,
					"patching_rect" : [ 719.0, 334.0, 129.0, 20.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"fontname" : "Arial",
					"id" : "obj-60"
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"offset" : 48,
					"patching_rect" : [ 719.0, 286.0, 196.0, 34.0 ],
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"mode" : 1,
					"id" : "obj-62",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patching_rect" : [ 14.0, 40.0, 609.0, 62.0 ],
					"numoutlets" : 0,
					"fontname" : "Arial",
					"id" : "obj-76"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 730.5, 101.0, 691.5, 101.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 691.5, 145.0, 728.5, 145.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 905.5, 325.0, 783.5, 325.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-62", 0 ],
					"hidden" : 0,
					"midpoints" : [ 715.5, 276.0, 728.5, 276.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 838.5, 361.0, 749.5, 361.0 ]
				}
