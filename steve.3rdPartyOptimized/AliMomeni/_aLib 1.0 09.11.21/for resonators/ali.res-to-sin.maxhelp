...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 262.0, 188.0, 15.0, 15.0 ],
					"id" : "obj-6",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 242.0, 124.0, 43.0, 43.0 ],
					"id" : "obj-7",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 223.0, 187.0, 15.0, 15.0 ],
					"id" : "obj-8",
					"numinlets" : 1
				}
...
, 			{
				"box" : 				{
					...
					"text" : "create a resonance model out of a sinusoidal model",
					"numoutlets" : 0,
					"fontsize" : 14.0,
					"patching_rect" : [ 32.0, 52.0, 370.0, 23.0 ],
					"id" : "obj-15",
					"fontname" : "Arial",
					"numinlets" : 1
				}
