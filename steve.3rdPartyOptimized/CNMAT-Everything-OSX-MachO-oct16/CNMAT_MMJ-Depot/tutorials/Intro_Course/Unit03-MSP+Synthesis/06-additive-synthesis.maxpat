{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 134.0, 44.0, 982.0, 830.0 ],
		"bglocked" : 0,
		"defrect" : [ 134.0, 44.0, 982.0, 830.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 33.0, 629.0, 20.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 73.0, 623.0, 60.0, 20.0 ],
					"text" : "*~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 73.0, 660.0, 35.0, 20.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 324.0, 45.0, 34.0 ],
					"text" : "master gain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 121.0, 646.0, 157.0, 62.0 ],
