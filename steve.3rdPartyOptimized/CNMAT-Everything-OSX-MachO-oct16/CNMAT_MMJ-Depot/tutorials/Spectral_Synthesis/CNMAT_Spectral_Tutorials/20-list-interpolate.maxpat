...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 106.0, 547.0, 133.0, 54.0 ],
					"id" : "obj-39",
					"args" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"patching_rect" : [ 30.0, 174.0, 136.0, 23.0 ],
					"id" : "obj-38"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Same partials, different order...",
					"linecount" : 2,
					"fontsize" : 12.0,
					...
					"fontname" : "Helvetica",
					"numoutlets" : 0,
					"patching_rect" : [ 414.0, 286.0, 107.0, 30.0 ],
					"id" : "obj-37"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 521.0, 326.0, 121.0, 16.0 ],
					"id" : "obj-2"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 394.0, 324.0, 121.0, 16.0 ],
					"id" : "obj-3"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Lists must be the same length!",
					"linecount" : 2,
					"fontsize" : 12.0,
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numinlets" : 1,
					"fontname" : "Helvetica",
					"numoutlets" : 0,
					"patching_rect" : [ 237.0, 289.0, 107.0, 30.0 ],
					"id" : "obj-4"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "This example could more musical.",
					"fontsize" : 12.0,
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numinlets" : 1,
					"fontname" : "Helvetica",
					"numoutlets" : 0,
					"patching_rect" : [ 321.0, 210.0, 194.0, 18.0 ],
					"id" : "obj-5"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 3,
					"patching_rect" : [ 164.0, 172.0, 46.0, 18.0 ],
					"id" : "obj-6"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 164.0, 151.0, 60.0, 18.0 ],
					"id" : "obj-7"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 266.0, 364.0, 61.0, 18.0 ],
					"id" : "obj-9"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 266.0, 385.0, 134.0, 16.0 ],
					"id" : "obj-10"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 2,
					"patching_rect" : [ 164.0, 291.0, 70.0, 18.0 ],
					"id" : "obj-11"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 164.0, 204.0, 36.0, 16.0 ],
					"id" : "obj-12"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 2,
					"patching_rect" : [ 34.0, 234.0, 40.0, 18.0 ],
					"id" : "obj-13"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 60.0, 361.0, 28.0, 16.0 ],
					"id" : "obj-15"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 60.0, 294.0, 20.0, 20.0 ],
					"id" : "obj-16"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 196.0, 204.0, 32.5, 16.0 ],
					"id" : "obj-17"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 4,
					"patching_rect" : [ 164.0, 265.0, 81.0, 18.0 ],
					"id" : "obj-18",
					"coll_data" : 					{
						"count" : 2,
						"data" : [ 							{
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 60.0, 331.0, 75.0, 18.0 ],
					"id" : "obj-19"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 163.0, 376.0, 82.0, 18.0 ],
					"id" : "obj-20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"color" : [ 1.0, 0.890196, 0.090196, 1.0 ],
					"patching_rect" : [ 60.0, 397.0, 84.0, 18.0 ],
					"id" : "obj-21"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"color" : [ 1.0, 0.890196, 0.090196, 1.0 ],
					"patching_rect" : [ 163.0, 353.0, 85.0, 18.0 ],
					"id" : "obj-22"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"numoutlets" : 0,
					"patching_rect" : [ 61.0, 587.0, 37.0, 20.0 ],
					"id" : "obj-28"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Trebuchet MS",
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 150.0, 159.0, 27.0 ],
					"id" : "obj-34"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "list-interpolate can be used to smoothly transition from one model to another.",
					"linecount" : 2,
					"fontsize" : 12.0,
					"frgb" : [ 0.0, 0.0, 0.0, 1.0 ],
					"numinlets" : 1,
					"fontname" : "Helvetica",
					"numoutlets" : 0,
					"patching_rect" : [ 320.0, 181.0, 224.0, 30.0 ],
					"id" : "obj-35"
				}
...
, 			{
				"box" : 				{
					...
					"background" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 314.0, 141.0, 227.0, 99.0 ],
					"id" : "obj-36"
				}
