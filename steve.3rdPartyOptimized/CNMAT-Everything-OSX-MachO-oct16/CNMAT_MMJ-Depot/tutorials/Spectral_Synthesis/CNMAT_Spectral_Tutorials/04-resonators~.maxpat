...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 0,
					"patching_rect" : [ 682.0, 328.0, 122.0, 30.0 ],
					"id" : "obj-10"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 670.0, 196.0, 60.0, 18.0 ],
					"id" : "obj-11"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 705.0, 250.0, 37.0, 16.0 ],
					"id" : "obj-12"
				}
...
, 			{
				"box" : 				{
					...
					"pattrmode" : 1,
					"numoutlets" : 3,
					"patching_rect" : [ 568.0, 196.0, 100.0, 18.0 ],
					"types" : [  ],
					"id" : "obj-13"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 568.0, 334.0, 111.0, 18.0 ],
					"id" : "obj-14"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 662.0, 304.0, 42.0, 18.0 ],
					"id" : "obj-15"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 1,
					"patching_rect" : [ 676.0, 248.0, 20.0, 20.0 ],
					"id" : "obj-16"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 662.0, 217.0, 115.0, 28.0 ],
					"id" : "obj-17"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 2,
					"patching_rect" : [ 662.0, 275.0, 49.0, 18.0 ],
					"id" : "obj-18",
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 614.0, 273.0, 42.0, 18.0 ],
					"id" : "obj-19"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 614.0, 247.0, 46.0, 18.0 ],
					"id" : "obj-20"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 0,
					"patching_rect" : [ 574.0, 161.0, 161.0, 30.0 ],
					"id" : "obj-25"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 262.0, 228.0, 188.0, 28.0 ],
					"id" : "obj-33"
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Helvetica",
					"numoutlets" : 1,
					"patching_rect" : [ 269.0, 259.0, 127.0, 16.0 ],
					"id" : "obj-34"
				}
...
, 			{
				"box" : 				{
					...
					"background" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.0, 127.0, 249.0, 262.0 ],
					"id" : "obj-46"
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-44", 0 ],
					"hidden" : 0,
					"midpoints" : [ 577.5, 374.0, 193.5, 374.0 ]
				}
