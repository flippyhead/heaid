{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 268.0, 44.0, 918.0, 478.0 ],
		"bglocked" : 0,
		"defrect" : [ 268.0, 44.0, 918.0, 478.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 428.0, 188.0, 100.0, 40.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 442.0, 316.0, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 399.0, 263.0, 90.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 324.0, 233.0, 170.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 325.0, 324.0, 108.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 325.0, 253.0, 67.0, 67.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"patching_rect" : [ 455.0, 341.0, 96.0, 20.0 ],
					"types" : [  ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 226.0, 106.0, 345.0, 62.0 ],
...
,
					"patching_rect" : [ 575.0, 413.0, 208.0, 27.0 ],
...
,
					"patching_rect" : [ 575.0, 368.0, 225.0, 27.0 ],
					"saved_object_attributes" : 					{
						"fontsize" : 12.0,
						"fontname" : "Arial",
						"default_fontface" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 617.0, 200.0, 231.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 616.0, 170.0, 243.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 617.0, 275.0, 288.0, 48.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 617.0, 245.0, 249.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 601.0, 140.0, 269.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 339.0, 13.0, 339.0, 89.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 243.0, 61.0, 20.0 ],
					"text" : "r decoder"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 54.0, 128.0, 90.0, 20.0 ],
					"text" : "global level"
				}
...
, 			{
				"box" : 				{
					...
					"orientation" : 0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 24.0, 83.0, 138.0, 37.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 24.0, 188.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 24.0, 158.0, 32.5, 20.0 ],
					"text" : "* 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 24.0, 218.0, 81.0, 20.0 ],
					"text" : "prepend gain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 383.0, 137.0, 17.0 ],
					"text" : "dac~ 1 2 3 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 90.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 238.0, 333.0, 53.0, 17.0 ],
					"text" : "receive~ Z"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 199.0, 310.0, 53.0, 17.0 ],
					"text" : "receive~ Y"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 159.0, 289.0, 53.0, 17.0 ],
					"text" : "receive~ X"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 119.0, 268.0, 56.0, 17.0 ],
					"text" : "receive~ W"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 120.0, 360.0, 161.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 174.0, 130.0, 50.0, 18.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 174.0, 160.0, 67.0, 17.0 ],
					"text" : "prepend width"
				}
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"hidden" : 0,
					"midpoints" : [ 183.5, 249.0, 87.0, 249.0, 87.0, 312.0, 129.5, 312.0 ],
					"source" : [ "obj-13", 0 ]
				}
